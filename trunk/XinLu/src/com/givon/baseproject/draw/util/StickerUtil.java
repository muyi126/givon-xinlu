...
//	private ImageView[] dotImageViews;
	public StickerUtil(Activity activity,View view,DrawView drawView) {
		...
		pageList = new View[1];
//		dotImageViews = new ImageView[1];
		pageList[0] = inflater.inflate(R.layout.stickerpic_page0, null);
...
//		pageList[8] = inflater.inflate(R.layout.stickerpic_page0, null);
...
//			dotImageViews[i].setImageResource(R.drawable.dotnormal);
		viewPager = (ViewPager)(view.findViewById(R.id.stickerviewpager));
