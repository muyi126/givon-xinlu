...
public class BackgroundUtil {
	...
	public BackgroundUtil(Activity drawActivity,View view,DrawView drawView){
		this.view = view;
		this.activity = drawActivity;
		this.drawView = drawView;			
	}
	public void backgroundPicSetOnClickListener() {
		ImageView[] backgrounds = new ImageView[6];
		backgrounds[0] = (ImageView)view.findViewById(R.id.smallpaper00);
		backgrounds[1] = (ImageView)view.findViewById(R.id.smallpaper01);
		backgrounds[2] = (ImageView)view.findViewById(R.id.smallpaper02);
		backgrounds[3] = (ImageView)view.findViewById(R.id.smallpaper03);
		backgrounds[4] = (ImageView)view.findViewById(R.id.smallpaper04);
		backgrounds[5] = (ImageView)view.findViewById(R.id.smallpaper05);
...
//				case R.id.smallpaper46:s = "bigpaper46.jpg";	
				...
				drawView.setBackgroundBitmap(DrawAttribute.
						getImageFromAssetsFile(activity,s,true), true);	
				break;
